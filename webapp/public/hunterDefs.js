...
window.HUNTER_DEFS = {
    ...
    globalUpgrades: {
      ...
      loopmods: {
        label: 'Loop Mods', items: [
          ...
          { id: 'stelzi', label: "Mutual Mining Agreement: The Stelzi", maxLevel: 8, temporary: true },
  ...
  ozzy: {
    ...
    globalUpgrades: {
      ...
      loopmods: { label: 'Loop Mods', items: [{ id: 'scavenger2', label: 'Scavengers Advantage 2', maxLevel: 25, temporary: true }, { id: 'stelzi', label: "Mutual Mining Agreement: The Stelzi", maxLevel: 8, temporary: true }, { id: 'roe', label: 'Ultima: Rule of Experience', maxLevel: Infinity, temporary: true }] },
      shardmilestones: { label: 'Milestones', items: [{ id: 'm0', label: '#0 The Eternal Milestone', maxLevel: Infinity }] },
  ...
  knox: {
    ...
    globalUpgrades: {
      ...
      loopmods: { label: 'Loop Mods', items: [{ id: 'stelzi', label: "Mutual Mining Agreement: The Stelzi", maxLevel: 8, temporary: true }, { id: 'roe', label: 'Ultima: Rule of Experience', maxLevel: Infinity, temporary: true }] },
