...
- **THE TALENT SEED USED FOR SCREENING IS NOT COSMETIC, AND TREATING IT AS COSMETIC COST 16.7% ON A
  ...
  **THE "SEED IS NOW TUNED" CLAIM THAT USED TO BE WRITTEN HERE WAS FALSE -- THE TUNING WAS NEVER
  ...
  and a AGENTS.md entry describing a fix, are not evidence the fix exists.** `grep` for the variable
...
- **FIVE MEASURED-DEAD SEARCH FLAGS ARE DELETED, AND THE DELETION IS VERIFIED BIT-IDENTICAL.**
  ...
  **CORRECTED 2026-09-07: ONE OF THE FIVE IS BACK, AND THE KEY COUNT IN THIS ENTRY WAS STALE.**
  ...
  AGENTS.md entry describing a fix, are not evidence the fix exists" -- applied to itself, and the
...
# Pending AGENTS.md entries (2026-09-07)
